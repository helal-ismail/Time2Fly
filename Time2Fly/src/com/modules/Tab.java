...
public class Tab implements Comparable<Tab> {
	...
	public int compareTo(Tab tab) {
		...
		if (CacheManager.getInstance().currentLoc != null) {
			hkLoc.setLatitude(CacheManager.getInstance().currentLoc
					.getLatitude());
			hkLoc.setLongitude(CacheManager.getInstance().currentLoc
					.getLongitude());
		} else {
